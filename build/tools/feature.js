...
const append_route = async ({ kebabCaseName, parent, errorBoundary, loader, action, middleware, Component, }) => {
...
export const feature = async ({ parent, name, route }) => {
    const pascalCaseName = name.charAt(0).toUpperCase() + name.slice(1);
    const kebabCaseName = (route || name).toLowerCase();
